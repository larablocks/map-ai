...
# 2. Fill in AGENTS.md line 2 — [PROJECT NAME] and [STACK DETAILS]
...
cp docs/memory/framework.example.md docs/memory/framework.md  # rename to match stack; update AGENTS.md + docs/MEMORY.md
